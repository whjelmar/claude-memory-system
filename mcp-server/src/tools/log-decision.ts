...
export const logDecisionTool = {
  ...
  description:
    "Logs a significant decision to the memory system. Creates an auto-numbered decision record with context, options considered (with pros/cons), the final decision, and expected consequences.",
  inputSchema: {
 ...
 */
function generateDecisionContent(
 ...
 */
export function formatLogDecisionResult(result: LogDecisionResult): string {
  return [
