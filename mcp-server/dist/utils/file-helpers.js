...
export function getProjectRoot() {
    const projectRoot = process.env.MEMORY_PROJECT_ROOT || process.argv[2] || process.cwd();
 ...
 */
export async function searchInFiles(dirPath, query, extension) {
    const results = [];
 ...
 */
export async function getNextNumber(dirPath, prefix) {
